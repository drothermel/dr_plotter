...
def main(args: Any) -> Any:
    ...
    with FigureManager(rows=2, cols=3, figsize=(18, 12)) as fm:
        ...
        fm.plot("scatter", 0, 0, data["scatter_data"],
            x="x", y="y",
            hue_by="category",
            theme=bold_theme,
            s=80,
        ...
        fm.plot("line", 0, 1, data["line_data"],
            x="time", y="value",
            hue_by="group",
            theme=subtle_theme,
            linewidth=3,
        ...
        fm.plot("violin", 0, 2, data["violin_data"],
            x="category", y="value",
            hue_by="group",
            theme=vibrant_theme,
            alpha=0.8,
        ...
        fm.plot("histogram", 1, 1, data["histogram_data"],
            x="values",
            bins=25,
            color="#4ECDC4",
            alpha=0.7,
        ...
        fm.plot("heatmap", 1, 2, data["heatmap_data"],
            x="column", y="row", values="value",
            cmap="plasma",
            alpha=0.95,
...
if __name__ == "__main__":
    parser = setup_arg_parser(description="Individual Styling Grid - Per-Subplot Customization")
