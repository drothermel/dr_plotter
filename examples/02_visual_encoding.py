...
def main(args):
    with FigureManager(rows=2, cols=2, figsize=(15, 12)) as fm:
        fm.fig.suptitle("Example 2: Visual Encoding - Color, Marker, and Style Systems", fontsize=16)
        ...
        fm.plot("scatter", 0, 0, color_data,
        ...
        fm.plot("scatter", 0, 1, marker_data,
        ...
        categorical_data = ExampleData.grouped_categories(n_categories=3, n_groups=2, seed=203)
        ...
        fm.plot("violin", 1, 0, categorical_data,
