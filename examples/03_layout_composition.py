"""
Example 3: Layout & Composition - Multi-subplot coordination and theme consistency.
Demonstrates FigureManager's ability to coordinate complex multi-plot layouts.
"""
...
def main(args):
    with FigureManager(rows=2, cols=2, figsize=(16, 12)) as fm:
        fm.fig.suptitle("Example 3: Layout & Composition - Multi-Subplot Coordination", fontsize=16)
        ...
        fm.plot("scatter", 0, 0, metric_data,
            x="x", y="metric_a",               # REQUIRED: data mapping
        ...
        fm.plot("scatter", 0, 1, layout_data,
        ...
        fm.plot("line", 1, 0, training_data,
            x="epoch", y="train_loss",         # REQUIRED: data mapping
