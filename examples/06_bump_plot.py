"""
Example 6: Bump Plot with the new Theming system.
"""
...
if __name__ == "__main__":
    ...
    # The bump plot will use its specific theme defaults (linewidth, markers, etc.)
    fig, _ = drp.bump_plot(
        sales_df,
        time_col="quarter",
        category_col="product",
        value_col="sales",
        title="Themed Product Sales Rankings Per Quarter",
    )
