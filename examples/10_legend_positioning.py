...
def main(args: Any) -> Any:
    ...
    with FigureManager(rows=2, cols=2, figsize=(16, 12), legend_strategy="figure_below", legend_position="lower center", legend_ncol=4) as fm:
        fm.fig.suptitle("Example 10: Legend Positioning + Management - Shared Figure Legend", fontsize=16)
        
        fm.plot("scatter", 0, 0, shared_data,
            x="performance",
            y="accuracy",
        ...
        fm.plot("line", 0, 1, shared_data.sort_values("performance"),
            x="performance",
            y="accuracy",
            hue_by="category_group",
            linewidth=2,
        ...
        fm.plot("scatter", 1, 0, shared_data,
            x="runtime",
            y="memory",
            hue_by="category_group",
            s=60,
        ...
        fm.plot("scatter", 1, 1, shared_data,
            x="performance",
            y="accuracy",
            hue_by="category_group",
            s=60,
...
if __name__ == "__main__":
    parser = setup_arg_parser(description="Legend Positioning + Management - Legend System Robustness")
