...
if __name__ == "__main__":
    ...
    for lr in learning_rates:
        for wd in weight_decays:
            train_loss, val_loss, train_acc, val_acc = simulate_training_run(epochs, lr, wd)
    ...
    fig.suptitle('ML Experiment: Multiple Metrics × Learning Rates × Weight Decay', fontsize=16)
    
    # --- Plot 1: Loss curves with metrics as color, LR as line style ---
    ax1 = axes[0, 0]
    drp.line(df, x='epoch', y=['train_loss', 'val_loss'],
    ...
    ax3 = axes[1, 0]
    drp.line(df, x='epoch', y=['train_accuracy', 'val_accuracy'],
    ...
    ax4 = axes[1, 1]
    drp.line(df, x='epoch', y='val_loss',
             hue='learning_rate',      # Color for LR
             style='weight_decay',     # Line style for WD
             ax=ax4,
