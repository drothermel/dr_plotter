...
def create_color_coordination_example() -> None:
    ...
    with FigureManager(rows=2, cols=3, figsize=(18, 12), theme=coordinated_theme) as fm:
        fm.fig.suptitle("Example 7: Color Coordination - Multi-Subplot Shared Styling", fontsize=18)
        ...
        fm.plot("violin", 0, 2, violin_data,
            x="category",                  
            y="value",                     
            hue_by="group",                
            showmeans=True,                
        ...
        fm.plot("histogram", 1, 1, alpha_dist_data,
            x="value",                     
            bins=25,                       
            color="#E74C3C",               
