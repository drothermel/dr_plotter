"""
Example 4: Violin Plot with the new Theming system.
"""
...
if __name__ == "__main__":
    ...
    data = pd.DataFrame(
        {
            "category": np.repeat(
                ["Category A", "Category B", "Category C", "Category D"], 25
            ),
    ...
    fig, _ = drp.violin(
        data, x="category", y="value_distribution", title="Themed Violin Plot"
    )
