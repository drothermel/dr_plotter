...
def main(args: Any) -> Any:
    ...
    with FigureManager(rows=3, cols=3, figsize=(24, 18)) as fm:
        fm.fig.suptitle("Example 5: All Plot Types - Systematic Verification of 8 Plotters", fontsize=20)
        ...
        fm.plot("histogram", 1, 0, single_dist_data,
            x="value",                     
            bins=30,                       
            alpha=0.7,                     
            color="steelblue",             
        ...
        fm.plot("violin", 1, 1, violin_data,
            x="category",                  
            y="value",                     
            hue_by="group",                
            alpha=0.8,                     
        ...
        fm.plot("heatmap", 1, 2, heatmap_data,
            x="column",                    
            y="row",                       
            values="value",                
            cmap="plasma",                 
        ...
        fm.plot("contour", 2, 0, contour_data,
            x="x",                         
            y="y",                         
            levels=8,                      
            alpha=0.8,                     
        ...
        ax_summary.text(0.1, 0.8, "Summary:", fontsize=16, fontweight="bold", transform=ax_summary.transAxes)
        ax_summary.text(0.1, 0.7, "• 8 plotters verified", fontsize=12, transform=ax_summary.transAxes)
        ax_summary.text(0.1, 0.6, "• Parameter variations tested", fontsize=12, transform=ax_summary.transAxes)
        ax_summary.text(0.1, 0.5, "• Legend generation confirmed", fontsize=12, transform=ax_summary.transAxes)
        ax_summary.text(0.1, 0.4, "• Theme system integration", fontsize=12, transform=ax_summary.transAxes)
        ax_summary.text(0.1, 0.3, "• StyleApplicator pipeline", fontsize=12, transform=ax_summary.transAxes)
        ax_summary.text(0.1, 0.2, "• FigureManager coordination", fontsize=12, transform=ax_summary.transAxes)
