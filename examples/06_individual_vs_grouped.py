...
def main(args: Any) -> Any:
    ...
    with FigureManager(rows=2, cols=4, figsize=(20, 10)) as fm:
        ...
        fm.plot("violin", 0, 2, shared_data,
            x="x_categorical",
            y="y_continuous",
            color="purple",
            alpha=0.6,
        ...
        fm.plot("violin", 1, 2, shared_data,
            x="x_categorical",
            y="y_continuous",
            hue_by="category_group",
            alpha=0.6,
