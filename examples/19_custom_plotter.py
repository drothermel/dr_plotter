...
class ErrorBarPlotter(BasePlotter):
    ...
    def prepare_data(self):
        ...
        self.plot_data = CustomErrorBarPlotData(self.raw_data, self.x, self.y, self.error).data
    ...
    def render(self, ax):
        ...
        ax.errorbar(self.plot_data[self.x], self.plot_data[self.y], yerr=yerr, 
                   fmt='o', **plot_kwargs)
...
if __name__ == "__main__":
    ...
    error_data = base_data.groupby("category").agg({
        "value": ["mean", "std"]
    }).reset_index()
