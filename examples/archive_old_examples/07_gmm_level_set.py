"""
Example 7: GMM Level Set Plot with the new Theming system.
"""
...
if __name__ == "__main__":
    ...
    # The plot will use the CONTOUR_THEME by default
    fig, _ = drp.gmm_level_set(
        data, x="x_coord", y="y_coord", title="Themed GMM Level Set Plot"
    )
