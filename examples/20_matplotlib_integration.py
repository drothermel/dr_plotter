...
if __name__ == "__main__":
    ...
    with FigureManager(rows=2, cols=2, figsize=(15, 12)) as fm:
        fm.fig.suptitle("Matplotlib Integration: Direct Parameter Pass-Through", fontsize=16)

        # Scatter with matplotlib parameters
        scatter_data = ExampleData.simple_scatter()
        fm.scatter(0, 0, scatter_data, x="x", y="y",
        ...
        fm.hist(1, 0, hist_data, x="values",
               ...
               linewidth=1.5)       # matplotlib: edge width
        ...
        fm.bar(1, 1, bar_summary, x="category", y="value",
              ...
              width=0.6)           # matplotlib: bar width
