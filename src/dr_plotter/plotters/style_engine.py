...
class StyleEngine:
    ...
    def generate_styles(self, data, hue=None, style=None, size=None, 
                       marker=None, alpha=None, shared_context=None):
        """
        ...
        column_to_channels = self._map_channels_to_columns(hue, style, size, marker, alpha)
        ...
        return self._build_group_combinations(
            data, column_to_channels, value_mappings
        )
    
    def _map_channels_to_columns(self, hue=None, style=None, size=None, marker=None, alpha=None):
                ...
                if cache_key in self._style_cache:
                    ...
                    for channel in channels:
                        if channel == "hue":
                            ...
                            if (shared_context and 
                                hasattr(shared_context, 'get') and
                                "_figure_manager" in shared_context):
    ...
    def get_grouping_columns(self, hue=None, style=None, size=None, marker=None, alpha=None):
        """
