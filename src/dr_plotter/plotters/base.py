...
class BasePlotter:
    ...
    def _melt_metrics(self, data, id_vars, value_vars, var_name='_metric', value_name='_value'):
        """
        ...
        if existing_value_vars:
            ...
            melted = pd.melt(data, id_vars=id_vars, value_vars=existing_value_vars,
        ...
        if missing_value_vars:
            ...
            if wide_data:
                ...
                melted = pd.concat([melted, wide_melted], ignore_index=True) if not melted.empty else wide_melted
    ...
    def _get_group_styles(self, data, hue=None, style=None, size=None, marker=None, alpha=None):
        """
    ...
    def _filter_plot_kwargs(self):
        ...
        filter_keys = DR_PLOTTER_STYLE_KEYS + ['hue', 'style', 'size', 'marker', 'alpha']
